...
begin
  res := '';
  if SameText(units, 'fahrenheit') then
    tempUnit := 'fahrenheit'
  else
    tempUnit := 'celsius';
  ...
  try
    cb.Request.AddHeader('user-agent', 'MyProject');
      ...
      begin
        ...
        try
          ...
          begin
            ...
            cb.Request.Path := '/v1/forecast?latitude='+lat+'&longitude='+lon
                ...
                try
                  ...
                  begin
                    ...
                    begin
                      ...
                      res := '{"temperature":'+temp.ToString+',"wind":'+wind.ToString+',"units":"'+tempUnit+'"}';
                    end;
                  end;
                finally
                  lJValue2.Free;
...
begin
  ...
  if Length(Args) > 1 then
    Units := Args[1].AsString
  else
    Units := 'celsius'; // default units

  WeatherData := GetWeather(City, Units);
