...
This README explains how to set up and use the TMS MCP Client Demo with servers using STDIO transport.

## Overview

The ClientDemo is a simple Model Context Protocol (MCP) host implementation that is capable of connecting to MCP servers utilizing the STDIO transport, and supports function calling with 7 LLMs: OpenAI, Claude, Gemini, Grok, Mistral, DeepSeek and Ollama
