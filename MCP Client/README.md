...
This README explains how to set up and use the `MCPClient` with servers using STDIO transport.

## Overview

The MCPClient is a simple Model Context Protocol (MCP) host implementation that is capable of connecting to MCP servers utilizing the STDIO transport, and supports function calling with 9 LLM services: OpenAI, Claude, Gemini, Grok, Mistral, DeepSeek OpenRouter, Ollama and llama.cpp
...
1. Open the `MCPClient.dproj` project in your Delphi IDE.
